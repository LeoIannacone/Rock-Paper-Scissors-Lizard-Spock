...
public class KPICore implements iKPIC, iKPIC_subscribeHandler2,  iKPIC_subscribeHandler
{
	...
	protected String         SMART_SPACE_NAME=null;
	...
	String getErrMess()
	{  if(KP_ERROR_ID<0)return "ERROR MESSAGE:"+ERR_MSG[(KP_ERROR_ID *-1)];
	else             return "SERVICE NOTE:"+ERR_MSG[(KP_ERROR_ID    )];
	}//String getErrMess()
	...
	{Thread x = new Thread()
	{ public void run() { try {sleep(msec);}  catch (InterruptedException e) { System.out.println("[sleep exception!]"+e); }                  } };
	x.start();      try{ x.join(); }catch(Exception e){}
	}//public void Sleep(final int msec)
...
//
	...
	return sendSSAPMsg( this.xmlTools.leave() );
	}//String leave()
	...
	return sendSSAPMsg( this.xmlTools.queryRDF(s, p, o, s_type, o_type) );
	}//String queryRDF()
	...
	{deb_print("\n[QUERY RDF]___________________________________");
	return sendSSAPMsg( this.xmlTools.queryRDF(queryList) ); 
	}//public String queryRDF( Vector<Vector<String>> queryList )
	...
	return sendSSAPMsg( this.xmlTools.insert(s, p, o, s_type, o_type) );
	...
	{deb_print("\n[INSERT]___________________________________");
	return sendSSAPMsg( this.xmlTools.insert(queryList) );
	}
	...
	return sendSSAPMsg( this.xmlTools.remove(s, p, o, s_type, o_type) );
	...
	{deb_print("\n[REMOVE]___________________________________");
	return sendSSAPMsg( this.xmlTools.remove(queryList) );
	}   
	...
	return sendSSAPMsg( this.xmlTools.update(sn, pn, on, sn_type, on_type 
	...
	public String update_sparql(String sparql_update )
	{
		...
		{
			return sendSSAPMsg( this.xmlTools.querySPARQL(sparql_update));
		}
		else
		{
			return sendSSAPMsg( this.xmlTools.update_sparql(sparql_update));
		}
	}//String update(String s,String p,String o)
	...
	{deb_print("\n[UPDATE]___________________________________");
	return sendSSAPMsg( this.xmlTools.update(newTripleVector, oldTripleVector) );
	}
	...
	return sendSSAPMsg( this.xmlTools.persistent_update(query ));
	}
	...
	public String cancel_persistent_update(String update_id)
	{
		...
		return sendSSAPMsg( this.xmlTools.cancel_persistent_update(update_id ));
	}
	...
	public String subscribeRDF(String s,String p,String o,String o_type, iKPIC_subscribeHandler2 handler)
	{
		deb_print("\n[SUBSCRIBE RDF]___________________________________"); 
		System.out.println("DEBUG: " + this.xmlTools.subscribeRDF(s, p, o, o_type));
	...
	public String subscribeRDF(Vector<Vector<String> > triples, iKPIC_subscribeHandler2 handler)
	{
		deb_print("\n[SUBSCRIBE RDF]___________________________________"); 
		//System.out.println("DEBUG: " + this.xmlTools.subscribeRDF(s, p, o, o_type));
	...
	public String subscribeSPARQL(String query, iKPIC_subscribeHandler2 handler)
	{
		deb_print("\n[SUBSCRIBE SPARQL]___________________________________"); 
	 ...
	 */
	private String subscribe(String msg, iKPIC_subscribeHandler2 handler)
	{
...
System.out.println("HERE!");
	 ...
	 */
	@Deprecated
	private String subscribe(String msg)
	{
		deb_print("KpCore:subscribe method");
		int ret=0;
	...
	return sendSSAPMsg( this.xmlTools.unsubscribe() );
	}//String unsubscribe()
	...
	{deb_print("\n[UNSUBSCRIBE]___________________________________");
	return sendSSAPMsg( this.xmlTools.unsubscribe(subscription_id) );
	}//String unsubscribe()
	...
	@Override
	@Deprecated
	public String insertProtection(String EntityI, Vector<String> properties)
	{
	...
	@Override
	@Deprecated
	public String removeProtection(String EntityI, Vector<String> properties)
	{
		Vector<Vector<String>> triples= new Vector<Vector<String>>(); 
		String xml="";
		boolean ack=false;	
		...
		xml= remove(triples);
		ack=xmlTools.isRemoveConfirmed(xml);
	...
	public String remove_rdf_xml(String graph){
		...
		return sendSSAPMsg( this.xmlTools.remove_rdf_xml(graph) );
	...
	public String insert_rdf_xml(String graph){
		...
		return sendSSAPMsg( this.xmlTools.insert_rdf_xml(graph) );
	...
	public String update_rdf_xml( String insGraph, String remGraph){
		deb_print("\n[UPDATE]___________________________________");
		return sendSSAPMsg( this.xmlTools.update_rdf_xml(insGraph, remGraph));
